...
const RideBooking = () => {
    ...
    const rideOptions = useMemo(() => [
        ...
        { type: "Auto", seats: 3, time: '1 min', droptime: '4:28 pm', price: farePrices?.auto, icon: require('@/assets/icons/auto.png') },
        { type: "Cab Economy", seats: 4, time: '1 min', droptime: '4:28 pm', price: farePrices?.cabEconomy, icon: require('@/assets/icons/cab.png') },
        { type: "Cab Premium", seats: 4, time: '1 min', droptime: '4:28 pm', price: farePrices?.cabPremium, icon: require('@/assets/icons/cab_premium.png') },
    ], [farePrices])
